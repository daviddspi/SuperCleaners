...
// Let's reference the accurate generated asset paths
...
export const SERVICES: Service[] = [
  {
    ...
    basePrice: 85,
    pricePerUnit: 15, // extra per room
    category: 'Specialist',
  ...
  },
  {
    ...
    basePrice: 65,
    pricePerUnit: 20, // extra per mattress
    category: 'Specialist',
  ...
  },
  {
    ...
    basePrice: 75,
    pricePerUnit: 25, // extra for double oven
    category: 'Detailing',
  ...
  },
  {
    ...
    basePrice: 55,
    pricePerUnit: 10, // extra per window pane
    category: 'Regular',
  ...
  },
  {
    ...
    basePrice: 199,
    pricePerUnit: 40, // extra per bedroom
  ...
  },
  {
    ...
    basePrice: 110,
    pricePerUnit: 30, // extra per item seat
    category: 'Specialist',
