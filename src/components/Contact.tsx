      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            <div className="relative z-10 p-6 sm:p-10 flex flex-col items-center text-center space-y-3.5 sm:space-y-5">
              {/* Icon container */}
              <div className="w-14 h-14 sm:w-20 sm:h-20 bg-white/15 backdrop-blur-md rounded-2xl border border-white/20 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-black/10">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 sm:w-10 sm:h-10 text-white">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">WhatsApp</h3>
                <p className="text-white/70 text-xs sm:text-sm mt-1 sm:mt-2 leading-relaxed max-w-xs mx-auto">
                  Pošaljite nam sliku i dobijte procenu cene — odgovaramo za par minuta.
                </p>
              </div>

              {/* CTA pill */}
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/25 text-white text-xs sm:text-sm font-semibold group-hover:bg-white/30 transition-colors">
          ...
          >
            ...
            <div className="relative z-10 p-6 sm:p-10 flex flex-col items-center text-center space-y-3.5 sm:space-y-5">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">Viber</h3>
                <p className="text-white/70 text-xs sm:text-sm mt-1 sm:mt-2 leading-relaxed max-w-xs mx-auto">
